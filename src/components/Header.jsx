...
export const Header = () => {
  return (
    <header className="min-w-290 w-full h-16 fixed top-0 left-0 flex items-center justify-center bg-(--steel-100) p-1 gap-3 shadow-md">
      <div className="w-56 h-full flex items-center justify-between p-2"> 
        <img src="/src/img/LogoPixelPhotography.svg" className="h-10 w-10" alt="logo" />
